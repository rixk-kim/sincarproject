...
public class NoticeContent {
    ...
    private static NoticeItem createDummyItem(int position) {
        return new NoticeItem(position, "[이벤트]할인쿠폰 이벤트","1", "2020.03.01", "SIN 그룹에서 스팀워시 대리점을 모집합니다. 송파지사, 서초지사에서 모집중이며 자세한 사항은 고객센터를 통해 연락부탁드립니다. SIN 그룹에서 스팀워시 대리점을 모집합니다. 송파지사, 서초지사에서 모집중이며 자세한 사항은 고객센터를 통해 연락부탁드립니다. SIN 그룹에서 스팀워시 대리점을 모집합니다. 송파지사, 서초지사에서 모집중이며 자세한 사항은 고객센터를 통해 연락부탁드립니다. SIN 그룹에서 스팀워시 대리점을 모집합니다. 송파지사, 서초지사에서 모집중이며 자세한 사항은 고객센터를 통해 연락부탁드립니다. 감사합니다. ");
    }
...
//    }
    ...
    public static class NoticeItem {
        ...
        public NoticeItem(int id, String title, String seq, String date, String contents) {
            this.id = id;
            this.title = title;
            this.seq = seq;
            this.date = date;
